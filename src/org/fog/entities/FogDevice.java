...
public class FogDevice extends PowerDatacenter {
	 ...
	 * <b>NOTE:</b> You do not need to override body() method, if you use this method.
	 *
	 * @pre $none
	 * @post $none
	 */
...
//	}
	...
	protected void sendUpFreeLink(Tuple tuple){
		/* With data placement */
		////*System.out.println("tuple:"+tuple.toString());
		int storageNodeId = getStorageNodeId(tuple);
	...
	// TODO offload
	protected void replyUpFreeLink(Tuple tuple){
		/* With data placement */
		////*System.out.println("tuple:"+tuple.toString());
		int storageNodeId = getStorageNodeId(tuple);
		////*System.out.println("Send tuple to the storage node:"+storageNodeId);
	...
	// TODO offload
	public void replyUp(Tuple tuple){
		replyUpFreeLink(tuple);
	}
